...
- dump1090.socket30003 is used under the GNU GENERAL PUBLIC LICENSE, version 3. This program is (C) by Ted Sluis (@tedsluis), and a slightly modified fork can be found at <https://github.com/sdr-enthusiasts/dump1090.socket30003>. Any modifications to dump1090.socket30003 are Copyright by their respective owners
- Maps and Nominatim reverse geocoding results are generated thanks to OpenStreetMap. OpenStreetMap® is open data, licensed under the Open Data Commons Open Database License (ODbL) by the OpenStreetMap Foundation (OSMF). "© OpenStreetMap contributors". More information, including license terms, can be found here: <https://www.openstreetmap.org/copyright>
