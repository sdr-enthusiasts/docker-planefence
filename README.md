...
- MANDATORY: First -- copy the template config file in place: `sudo cp /usr/share/planefence/persistplanefence.config-RENAME-and-EDIT-me /usr/share/planefence/persist/planefence.config`
